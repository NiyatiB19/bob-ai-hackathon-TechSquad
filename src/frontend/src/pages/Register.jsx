...
export default function Register() {
  ...
  const handleGoogleSignUp = () => {
    setRegisterNotice('Google OAuth provider integration prepared for backend connection.');
    setTimeout(() => setRegisterNotice(null), 4000);
  };
      ...
      <div className="relative lg:w-[42%] w-full bg-slate-50 flex flex-col justify-between p-6 sm:p-10 lg:p-12 min-h-screen">
        ...
        <div className="relative z-10 w-full max-w-md mx-auto my-auto space-y-6">
          ...
          <div className="relative flex items-center justify-center my-4">
            ...
            <span className="absolute bg-slate-50 px-3 text-[10px] font-semibold text-slate-400 uppercase tracking-widest">
              OR
            </span>
          </div>
          ...
          <button
            ...
            className="w-full py-3 px-4 bg-white border border-slate-200 hover:border-slate-300 hover:bg-slate-50 text-slate-700 font-semibold text-xs rounded-xl transition-all shadow-sm flex items-center justify-center space-x-2.5 cursor-pointer"
          >
