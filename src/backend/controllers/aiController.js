 ...
 */
async function analyzeShipmentHandler(req, res) {
  try {
    const { shipmentId, shipment } = req.body || {};
    const { analyzeShipment } = await import('../../ai/services/aiRecommendationService.js');
...
module.exports = { analyzeShipmentHandler };
